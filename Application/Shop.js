...
const Item = ({ imageSource, itemName, onPress, avatarImage, link }) => {
  return (
    <View style={styles.itemContainer}>
      <TouchableOpacity style={styles.button} onPress={() => onPress(itemName, avatarImage, link)}>
...
const OverlayPage = ({ visible, onClose, overlayText, avatarImage, link }) => {
  const handleReal = () => {
  ...
  return (
    ...
    >
      ...
      <Text style={styles.overlayText}>{overlayText}</Text>
        ...
        <TouchableOpacity onPress={handleReal}>
...
export default function Shop() {
  ...
  const openOverlay = (text, image, link) => {
